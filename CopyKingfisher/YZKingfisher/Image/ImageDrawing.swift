...
extension KingfisherWrapper where Base: KFCrossPlatformImage {
    ...
    public func blurred(withRadius radius: CGFloat) -> KFCrossPlatformImage {
        ...
        for _ in 0 ..< iterations {
            ...
            vImageBoxConvolve_ARGB8888(&inBuffer, &outBuffer, nil, 0, 0, UInt32(targetRadius), UInt32(targetRadius), nil, flag)
        ...
        #else
        let result = outContext.makeImage().flatMap { KFCrossPlatformImage(cgImage: $0, scale: base.scale, orientation: base.imageOrientation)
        }
        #endif
